    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 pt-16 lg:pt-16">
                        ...
                        <div className="relative mb-[23px]">
                          ...
                          <div className="absolute h-[269.078px] left-[13px] rounded-[10px] top-[16.21px] w-[230.175px]">
                            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[10px]">
                              <Image
                                alt=""
                                src="/assets/tipping-point-ph.png"
                                fill
                                {...(setIndex === 0
                                  ? { priority: true }
                                  : { loading: "eager" as const })}
        ...
        <div className="bg-[#f5f5f5] rounded-[20px] py-7 px-4 sm:px-14 overflow-hidden">
          <p className="font-medium text-[12px] tracking-[-0.24px] text-[rgba(0,0,0,0.5)] mb-4">
          ...
          <div className="relative w-full overflow-hidden">
            <div className="animate-scroll-left flex items-center gap-8 sm:gap-13 whitespace-nowrap">
              {/* Original Set */}
              <Image
                src="/assets/2a5273e5aed69ad3d4df4c829002d030fb6dd0f9.png"
                alt=""
                width={180}
                height={45}
                priority
                className="h-[45px] w-auto inline-block saturate-0 hover:saturate-100 transition-all duration-300"
              />
              <Image
                src="/assets/9082ff0bf260fb00c1181da0dee181c62313fe63.png"
                alt=""
                width={180}
                height={45}
                priority
              ...
              />
              <Image
                src="/assets/2745adfddd032591a885cd1b9e93be75770a2008.png"
                alt=""
                width={180}
                height={45}
                priority
              ...
              />
              <Image
                src="/assets/8acca7c83c2f4babcf44ec6af2dd1d14daf913ca.png"
                alt=""
                width={180}
                height={45}
                priority
              ...
              />
              <Image
                src="/assets/7b411cb32f491fb308a26e8a3230d10a43f4a8a0.png"
                alt=""
                width={180}
                height={45}
                priority
