...
const steps: Step[] = [
  {
    ...
    description:
      "Select the package that fits your business and complete your subscription.",
    numberPath: "1",
  },
  {
    number: "2",
    ...
    description:
      "Fill out a simple form so we understand your business and goals",
    numberPath: "2",
  },
  {
    number: "3",
    ...
    description:
      "We align on strategy and design a website tailored to your brand.",
    numberPath: "3",
  },
  {
    number: "4",
    ...
    description:
      "Your site is built, reviewed, and launched for the world to see.",
    numberPath: "4",
  },
];
...
export function HowItWorksSection({
  ...
  const { elementRef: headerRef, isVisible: headerVisible } =
    useScrollAnimation();
  const { elementRef: stepsRef, isVisible: stepsVisible } =
    useScrollAnimation();
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20">
        ...
        <div
          ref={headerRef}
          className={`flex flex-col items-center text-center mb-8 scroll-animate ${headerVisible ? "scroll-animate-visible" : ""}`}
        >
          <div className="flex items-center gap-1 mb-2">
            <div className="h-0 w-14 border-t border-[#5757ff]" />
            <img
              src="/assets/how-it-works-icon.svg"
              alt=""
        ...
        <div
          ref={stepsRef}
          className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1280px] mx-auto"
        >
